...
const Hero = () => {
  return (
    <div className='flex flex-col items-center  justify-center w-full md:pt-36 pt-20 px-7 md:px-0 pace-y-7 text-center bg-gardient-to-b fro-cyan-100/70'>
       <h1 className='md:text-home-heading-larger text-home-heading-small relative font-bold text-gray-800 max-w-2xl mx-auto'>Welcome to StudyVerse! <span className='text-lime-600'> Ready to explore knowledge at your fingertips?</span><img src={assets.sketch}alt="sketch" className='md:block hidden absolute -bottom-1 right-0 opacity-70'/></h1>
