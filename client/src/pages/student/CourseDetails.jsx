      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-3 text-sm'>
         <p>{calculateRating(courseData)}</p>
            ...
            <p className='text-sm'>Course by <span className='text-blue-600'>StudyVerse</span></p>
                ...
                {courseData.courseContent.map((chapter, index)=>(
                  <div key={index} className= 'border border-gray-300 bg-white mb-2 rounded'>
                    ...
                    <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'}`}>
                      <ul className='list-disc md:pl-10 pl-4 pr-4 p-2 text-gray-600 border-t border-gray-300'>
                          ...
                          <li key={i} className='flex items-start gap-2 py-1'>
                            ...
                            <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                              ...
                              <div className='flex gap-2'>
                                {lecture.isPreviewFree && <p className='text-blue-500 cursor-pointer'>Prewiew</p>}
      ...
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w[420px]'>
        ...
        <div className='p-5'>
          ...
          <div className='flex gap-3 items-center pt-2'>
            ...
            <p className='md:text-lg taxt-gray-500 line-through'>{currency}{courseData.coursePrice}</p>
