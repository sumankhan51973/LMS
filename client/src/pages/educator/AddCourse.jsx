...
<div className='flex flex-col gap-1'>
  ...
  type="number" placeholder='0' min={0} max={100} className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' required />
</div>
...
<div>
 ...
 <button type="submit" className="bg-black text-white w-max px-8 py-2.5 rounded my-4">Add</button>
